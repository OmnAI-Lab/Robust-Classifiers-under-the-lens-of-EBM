...
def sample_q_SGLD(
    ...
    **kwargs,
    ...
    return x0, samples, ret_energy, all_samples
    ...
    **kwargs,
    ...
    for l in label:
        ...
        for _ in range(n_steps_sampling):
            if algo == "SGLD":
                x0, final_samples, energy_dict, all_samples = sample_q_SGLD(
                    model=model,
                    replay_buffer=replay_buffer,
                    batch_size=batch_size,
                    step_size=step_size,
    ...
    if compute_energy_model is not None:
        return tensor_x0, tensor_samples, energy_dict, all_samples
    else:
        return tensor_x0, tensor_samples , all_samples
